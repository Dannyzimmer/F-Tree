from resources.libs.fcodes.fcodes.libs.data.keys import linage_key, structure, switch_layer_sex, forbidden_structure
from resources.libs.fcodes.fcodes.libs.classes import Exceptions
from resources.libs.fcodes.fcodes.libs.data.language import consanguinity_key
class FcodeManager:
    '''
