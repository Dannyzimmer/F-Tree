...
from resources.libs.fcodes.fcodes.libs.data.keys import symbols, types, legend, forbidden_structure
from resources.libs.fcodes.fcodes.libs.data.random import names as nms
import math
