first_name_dic = {
    'F': [
        ...
        "Nevaeh", "Serenity", "Liliana", "Ayla", "Everleigh", "Raelynn"
    ],
    'M': [
        ...
        'Bennett', 'Robert', 'Jameson', 'Landon', 'Silas', 'Jose', 'Beau', 'Micah', 'Colton', 'Jordan',
        'Jeremiah', 'Parker', 'Greyson', 'Rowan', 'Adam', 'Nicholas', 'Theo', 'Xavier'
    ],
    'U': ['¿?']
}
...
surnames = [
    ...
    "color.green", "Adams", "Nelson", "Baker", "Hall", "Rivera", "Campbell", "Mitchell", 
