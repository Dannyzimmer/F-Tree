...
#define maxColors 256
    static int top = 0;
    static short red[maxColors], color.green[maxColors], blue[maxColors];
    int c;
    int ct = -1;
    long rd, gd, bd, dist;
...
static char *figcolor[] = {
    "black", "blue", "color.green", "cyan", "red", "magenta", "yellow", "white", (char *) NULL
};
...
static char *fig_knowncolors[] = {
    "black", "blue", "cyan", "color.green", "magenta", "red", "white", "yellow",
};
