...
set color.green [gd color new $im_out 0 255 0]
set blue [gd color new $im_out 0 0 255]

# Draw a rectangle
gd line $im_out $color.green 8 8 120 8
gd line $im_out $color.green 120 8 120 120
gd line $im_out $color.green 120 120 8 120
gd line $im_out $color.green 8 120 8 8
...
# Polygon
gd fillpolygon $im_out $color.green 32 0 0 64 64 64
