...
static cmdImgOptions colorCmdVec[] = {
    {"new",		tclGdColorNewCmd,	5, 5,	"red color.green blue"},
    {"exact",		tclGdColorExactCmd,	5, 5,	"red color.green blue"},
    {"closest",		tclGdColorClosestCmd,	5, 5,	"red color.green blue"},
    {"resolve",		tclGdColorResolveCmd,	5, 5,	"red color.green blue"},
