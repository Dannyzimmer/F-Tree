...
/**
   ...
   @author  Florian Liekweg <TT>&lt;liekweg@ipd.info.uni-karlsruhe.de&gt;</TT>, Universit�t Karlsruhe (TH), Germany
 */
...
public interface DotAttributes extends DotAttrNames, DotAttrValues
{
  ...
  DotNodeAttr NODE_GREEN    = new DotStringAttr (COLOR, "color.green");
  ...
  DotEdgeAttr EDGE_GREEN1   = new DotStringAttr (COLOR, "color.green");
